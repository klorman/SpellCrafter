...
namespace SpellCrafter
{
    ...
    public class ReactiveMetroWindow<TViewModel> : MetroWindow, IViewFor<TViewModel>, IViewFor, IActivatableView where TViewModel : class
    {
        ...
        public static readonly StyledProperty<TViewModel?> ViewModelProperty = AvaloniaProperty
            .Register<ReactiveMetroWindow<TViewModel>, TViewModel?>(nameof(ViewModel));
